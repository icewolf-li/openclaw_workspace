...
# 设置中文字体（根据你的系统选择） 
# Windows 系统用 'SimHei'，Mac 系统用 'Arial Unicode MS' 
rcParams['font.sans-serif'] = ['SimHei', 'DejaVu Sans', 'Bitstream Vera Sans'] 
...
# 保存高清图片 
png_file = '简单斜率图_调节效应.png'
pdf_file = '简单斜率图_调节效应.pdf'

plt.savefig(png_file, dpi=300, bbox_inches='tight')
plt.savefig(pdf_file, dpi=300, bbox_inches='tight')

print(f"✅ 图形已生成并保存为 '{png_file}' 和 '{pdf_file}'")
print(f"文件路径: {os.path.join(current_dir, png_file)}")
